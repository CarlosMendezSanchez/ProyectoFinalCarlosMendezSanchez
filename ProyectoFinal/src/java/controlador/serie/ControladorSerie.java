 ...
 * @author carlos
 */
@WebServlet(name = "ControladorSerie", urlPatterns = {"/usuario/ControladorSerie"})
public class ControladorSerie extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Listar las series existentes
        List<Series> series = ss.findSeriesEntities();
        request.setAttribute("series", series);
        emf.close();
        // Redirigir a /usuario/series.jsp
        getServletContext().getRequestDispatcher("/usuario/series.jsp").forward(request, response);
    }
