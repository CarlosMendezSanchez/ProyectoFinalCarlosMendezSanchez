 ...
 * @author carlos
 */
@WebServlet(name = "ControladorMostrarSerieMeGusta", urlPatterns = {"/usuario/ControladorMostrarSerieMeGusta"})
public class ControladorMostrarSerieMeGusta extends HttpServlet {
