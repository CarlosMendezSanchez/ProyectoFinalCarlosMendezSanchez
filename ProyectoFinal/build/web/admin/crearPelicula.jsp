...
<html>
    ...
    <body class="justify-content-center align-items-center color-fondo">
        ...
        <div class="d-flex justify-content-center align-items-center min-vh-100 abajo-arriba">
            <div class="card p-4 text-white shadow-lg rounded-4 anchura color-fondo-formulario">
                <form method="post" id="formularioCrearPeli">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <span class="error" id="error-imagen">Introduzca una imagen vertical válida.</span>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control border-0 border-bottom border-warning text-white campo-fondo" type="number" name="duracion" id="duracion">
    ...
    <footer class="text-white pt-5 color-fondo-formulario">
        ...
        <script src="../javascript/formularioCrearPeli.js"></script>
