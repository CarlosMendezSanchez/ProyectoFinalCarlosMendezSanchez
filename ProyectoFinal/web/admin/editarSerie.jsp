<%-- 
    ...
    Created on : 17 may 2025, 11:17:40
    Author     : carlos
--%>
    ...
    <body class="justify-content-center align-items-center color-fondo">
        ...
        <div class="d-flex justify-content-center align-items-center min-vh-100 abajo-arriba">
            <div class="card p-4 text-white shadow-lg rounded-4 anchura color-fondo-formulario">
                <form method="post" id="formularioEditarSerie">
                    <input type="hidden" name="id" value="${series.id}">

                    <div class="mb-3">
                        <label class="form-label fw-bold">Título</label>
                        <input class="form-control border-0 border-bottom border-warning text-white campo-fondo" type="text" name="titulo" id="titulo" value="${series.titulo}">
                        <span class="error" id="error-titulo">Introduzca un título válido.</span>
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold">Nombre de imagen</label>
                        <input class="form-control border-0 border-bottom border-warning text-white campo-fondo" type="text" name="imagen" id="imagen" value="${series.imagen}">
                        <span class="error" id="error-imagen">Introduzca una imagen válida.</span>
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold">Descripción</label>
                        <textarea class="form-control border-0 border-bottom border-warning text-white campo-fondo" name="descripcion" id="descripcion" rows="3">${series.descripcion}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control border-0 border-bottom border-warning text-white campo-fondo" type="number" name="temporadas" id="temporadas" value="${series.temporadas}">
                        <span class="error" id="error-temporadas">Introduzca un número de temporadas válidas.</span>
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold">Género</label>
                        <input class="form-control border-0 border-bottom border-warning text-white campo-fondo" type="text" name="genero" id="genero" value="${series.genero}">
                        <span class="error" id="error-genero">Introduzca un género válido.</span>
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-bold">Año</label>
                        <input class="form-control border-0 border-bottom border-warning text-white campo-fondo" type="text" name="ano" id="ano" value="${series.ano}">
                ...
                <div class="text-center mt-3">
                    <a class="text-warning small" href="${pageContext.request.contextPath}/admin/ControladorInicioAdminSeries">Volver a inicio</a>
                </div>
            </div>
        </div>
        ...
        <script src="../javascript/formularioEditarSerie.js"></script>
